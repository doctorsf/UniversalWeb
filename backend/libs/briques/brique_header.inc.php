			...
			echo '<nav class="navbar navbar-expand-md navbar-dark bg-info rounded">';
				...
				echo '<div class="collapse navbar-collapse" id="navbarNavDropdown">';
					...
					echo '<ul class="navbar-nav">';
						...
						//mise en place du visuel "entrée de menu active"
						$active = '';
						if (in_array($scriptName, array(_URL_LISTING_DROITS_, _URL_ACTIONS_DROITS_, _URL_LISTING_USERS_, _URL_USER_, _URL_MAINTENANCE_, _URL_INFOS_SYSTEME_, _URL_LISTING_LOGS_))) $active = ' active';
						echo '<li class="nav-item dropdown'.$active.'">';
