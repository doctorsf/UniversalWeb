...
//-----------------------------------------------------------------------
// Méthode MultiCell améliorée le 06.11.2017 par Fabrice LABROUSSE
// Elle renvoie maintenant le nombre de lignes écrites dans la cellule
// Par ajout de la variable $nbLines. Avant la méthode ne renvoyait rien
//-----------------------------------------------------------------------
...
/*******************************************************************************
*                         Méthode rajoutée à la classe de base				   *
*******************************************************************************/

//méthode ajoutées par moi
...
/*
Auteur      : Antoine Michéa
Web         : saturn-share.org
Programme   : pointilles.php
Licence     : GPL v2
Description : Permet de tracer un rectangle en pointillés (utile pour les zones à découper). Les paramètres sont :
              x1, y1       : coin supérieur gauche du rectangle.
              x2, y2       : coin inférieur droit du rectangle.
              epaisseur    : épaisseur des pointillés (1 par défaut).
              nbPointilles : nombre de pointillés par ligne (15 par défaut).
Date        : 07/01/2003
*/
...
//--------------------------------------------------------------
// Méthode améliorée le 06.11.2017 par Fabrice LABROUSSE
// Elle renvoie maintenant le nombre de lignes écrites dans la cellule
// Par ajout de la variable $nbLines. Avant la méthode ne renvoyait rien
//--------------------------------------------------------------
